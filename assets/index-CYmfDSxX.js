 ...
 */const hS=Symbol();var Oh;(function(t){t.direct="direct",t.patchObject="patch object",t.patchFunction="patch function"})(Oh||(Oh={}));function pS(){const t=t0(!0),e=t.run(()=>De({}));let n=[],s=[];const i=t_({install(r){i._a=r,r.provide(hS,i),r.config.globalProperties.$pinia=i,s.forEach(o=>n.push(o)),s=[]},use(r){return!this._a&&!dS?s.push(r):n.push(r),this},_p:n,_a:null,_e:t,_s:new Map,state:e});return i}/*!
  ...
  * (c) 2024 Eduardo San Martin Morote
  * @license MIT
  */const fi=typeof document<"u";function mS(t){return t.__esModule||t[Symbol.toStringTag]==="Module"}const we=Object.assign;function zl(t,e){const n={};for(const s in e){const i=e[s];n[s]=Gt(i)?i.map(t):t(i)}return n}const wr=()=>{},Gt=Array.isArray,$_=/#/g,_S=/&/g,gS=/\//g,vS=/=/g,yS=/\?/g,U_=/\+/g,bS=/%5B/g,ES=/%5D/g,W_=/%5E/g,wS=/%60/g,V_=/%7B/g,CS=/%7C/g,H_=/%7D/g,TS=/%20/g;function Mu(t){return encodeURI(""+t).replace(CS,"|").replace(bS,"[").replace(ES,"]")}function SS(t){return Mu(t).replace(V_,"{").replace(H_,"}").replace(W_,"^")}function Ic(t){return Mu(t).replace(U_,"%2B").replace(TS,"+").replace($_,"%23").replace(_S,"%26").replace(wS,"`").replace(V_,"{").replace(H_,"}").replace(W_,"^")}function IS(t){return Ic(t).replace(vS,"%3D")}function AS(t){return Mu(t).replace($_,"%23").replace(yS,"%3F")}function OS(t){return t==null?"":AS(t).replace(gS,"%2F")}function $r(t){try{return decodeURIComponent(""+t)}catch{}return""+t}const NS=/\/$/,RS=t=>t.replace(NS,"");function Kl(t,e,n="/"){let s,i={},r="",o="";const a=e.indexOf("#");let l=e.indexOf("?");return a<l&&a>=0&&(l=-1),l>-1&&(s=e.slice(0,l),r=e.slice(l+1,a>-1?a:e.length),i=t(r)),a>-1&&(s=s||e.slice(0,a),o=e.slice(a,e.length)),s=DS(s??e,n),{fullPath:s+(r&&"?")+r+o,path:s,query:i,hash:$r(o)}}function PS(t,e){const n=e.query?t(e.query):"";return e.path+(n&&"?")+n+(e.hash||"")}function Nh(t,e){return!e||!t.toLowerCase().startsWith(e.toLowerCase())?t:t.slice(e.length)||"/"}function xS(t,e,n){const s=e.matched.length-1,i=n.matched.length-1;return s>-1&&s===i&&Pi(e.matched[s],n.matched[i])&&j_(e.params,n.params)&&t(e.query)===t(n.query)&&e.hash===n.hash}function Pi(t,e){return(t.aliasOf||t)===(e.aliasOf||e)}function j_(t,e){if(Object.keys(t).length!==Object.keys(e).length)return!1;for(const n in t)if(!kS(t[n],e[n]))return!1;return!0}function kS(t,e){return Gt(t)?Rh(t,e):Gt(e)?Rh(e,t):t===e}function Rh(t,e){return Gt(e)?t.length===e.length&&t.every((n,s)=>n===e[s]):t.length===1&&t[0]===e}function DS(t,e){if(t.startsWith("/"))return t;if(!t)return e;const n=e.split("/"),s=t.split("/"),i=s[s.length-1];(i===".."||i===".")&&s.push("");let r=n.length-1,o,a;for(o=0;o<s.length;o++)if(a=s[o],a!==".")if(a==="..")r>1&&r--;else break;return n.slice(0,r).join("/")+"/"+s.slice(o).join("/")}const Fn={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};var Ur;(function(t){t.pop="pop",t.push="push"})(Ur||(Ur={}));var Cr;(function(t){t.back="back",t.forward="forward",t.unknown=""})(Cr||(Cr={}));function LS(t){if(!t)if(fi){const e=document.querySelector("base");t=e&&e.getAttribute("href")||"/",t=t.replace(/^\w+:\/\/[^\/]+/,"")}else t="/";return t[0]!=="/"&&t[0]!=="#"&&(t="/"+t),RS(t)}const MS=/^[^#]+#/;function FS(t,e){return t.replace(MS,"#")+e}function $S(t,e){const n=document.documentElement.getBoundingClientRect(),s=t.getBoundingClientRect();return{behavior:e.behavior,left:s.left-n.left-(e.left||0),top:s.top-n.top-(e.top||0)}}const el=()=>({left:window.scrollX,top:window.scrollY});function US(t){let e;if("el"in t){const n=t.el,s=typeof n=="string"&&n.startsWith("#"),i=typeof n=="string"?s?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!i)return;e=$S(i,t)}else e=t;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.scrollX,e.top!=null?e.top:window.scrollY)}function Ph(t,e){return(history.state?history.state.position-e:-1)+t}const Ac=new Map;function WS(t,e){Ac.set(t,e)}function VS(t){const e=Ac.get(t);return Ac.delete(t),e}let HS=()=>location.protocol+"//"+location.host;function B_(t,e){const{pathname:n,search:s,hash:i}=e,r=t.indexOf("#");if(r>-1){let a=i.includes(t.slice(r))?t.slice(r).length:1,l=i.slice(a);return l[0]!=="/"&&(l="/"+l),Nh(l,"")}return Nh(n,t)+s+i}function jS(t,e,n,s){let i=[],r=[],o=null;const a=({state:p})=>{const _=B_(t,location),E=n.value,T=e.value;let O=0;if(p){if(n.value=_,e.value=p,o&&o===E){o=null;return}O=T?p.position-T.position:0}else s(_);i.forEach(S=>{S(n.value,E,{delta:O,type:Ur.pop,direction:O?O>0?Cr.forward:Cr.back:Cr.unknown})})};function l(){o=n.value}function u(p){i.push(p);const _=()=>{const E=i.indexOf(p);E>-1&&i.splice(E,1)};return r.push(_),_}function f(){const{history:p}=window;p.state&&p.replaceState(we({},p.state,{scroll:el()}),"")}function h(){for(const p of r)p();r=[],window.removeEventListener("popstate",a),window.removeEventListener("beforeunload",f)}return window.addEventListener("popstate",a),window.addEventListener("beforeunload",f,{passive:!0}),{pauseListeners:l,listen:u,destroy:h}}function xh(t,e,n,s=!1,i=!1){return{back:t,current:e,forward:n,replaced:s,position:window.history.length,scroll:i?el():null}}function BS(t){const{history:e,location:n}=window,s={value:B_(t,n)},i={value:e.state};i.value||r(s.value,{back:null,current:s.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function r(l,u,f){const h=t.indexOf("#"),p=h>-1?(n.host&&document.querySelector("base")?t:t.slice(h))+l:HS()+t+l;try{e[f?"replaceState":"pushState"](u,"",p),i.value=u}catch(_){console.error(_),n[f?"replace":"assign"](p)}}function o(l,u){const f=we({},e.state,xh(i.value.back,l,i.value.forward,!0),u,{position:i.value.position});r(l,f,!0),s.value=l}function a(l,u){const f=we({},i.value,e.state,{forward:l,scroll:el()});r(f.current,f,!0);const h=we({},xh(s.value,l,null),{position:f.position+1},u);r(l,h,!1),s.value=l}return{location:s,state:i,push:a,replace:o}}function zS(t){t=LS(t);const e=BS(t),n=jS(t,e.state,e.location,e.replace);function s(r,o=!0){o||n.pauseListeners(),history.go(r)}const i=we({location:"",base:t,go:s,createHref:FS.bind(null,t)},e,n);return Object.defineProperty(i,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(i,"state",{enumerable:!0,get:()=>e.state.value}),i}function KS(t){return t=location.host?t||location.pathname+location.search:"",t.includes("#")||(t+="#"),zS(t)}function GS(t){return typeof t=="string"||t&&typeof t=="object"}function z_(t){return typeof t=="string"||typeof t=="symbol"}const K_=Symbol("");var kh;(function(t){t[t.aborted=4]="aborted",t[t.cancelled=8]="cancelled",t[t.duplicated=16]="duplicated"})(kh||(kh={}));function xi(t,e){return we(new Error,{type:t,[K_]:!0},e)}function dn(t,e){return t instanceof Error&&K_ in t&&(e==null||!!(t.type&e))}const Dh="[^/]+?",YS={sensitive:!1,strict:!1,start:!0,end:!0},qS=/[.+*?^${}()[\]/\\]/g;function QS(t,e){const n=we({},YS,e),s=[];let i=n.start?"^":"";const r=[];for(const u of t){const f=u.length?[]:[90];n.strict&&!u.length&&(i+="/");for(let h=0;h<u.length;h++){const p=u[h];let _=40+(n.sensitive?.25:0);if(p.type===0)h||(i+="/"),i+=p.value.replace(qS,"\\$&"),_+=40;else if(p.type===1){const{value:E,repeatable:T,optional:O,regexp:S}=p;r.push({name:E,repeatable:T,optional:O});const b=S||Dh;if(b!==Dh){_+=10;try{new RegExp(`(${b})`)}catch(N){throw new Error(`Invalid custom RegExp for param "${E}" (${b}): `+N.message)}}let C=T?`((?:${b})(?:/(?:${b}))*)`:`(${b})`;h||(C=O&&u.length<2?`(?:/${C})`:"/"+C),O&&(C+="?"),i+=C,_+=20,O&&(_+=-8),T&&(_+=-20),b===".*"&&(_+=-50)}f.push(_)}s.push(f)}if(n.strict&&n.end){const u=s.length-1;s[u][s[u].length-1]+=.7000000000000001}n.strict||(i+="/?"),n.end?i+="$":n.strict&&(i+="(?:/|$)");const o=new RegExp(i,n.sensitive?"":"i");function a(u){const f=u.match(o),h={};if(!f)return null;for(let p=1;p<f.length;p++){const _=f[p]||"",E=r[p-1];h[E.name]=_&&E.repeatable?_.split("/"):_}return h}function l(u){let f="",h=!1;for(const p of t){(!h||!f.endsWith("/"))&&(f+="/"),h=!1;for(const _ of p)if(_.type===0)f+=_.value;else if(_.type===1){const{value:E,repeatable:T,optional:O}=_,S=E in u?u[E]:"";if(Gt(S)&&!T)throw new Error(`Provided param "${E}" is an array but it is not repeatable (* or + modifiers)`);const b=Gt(S)?S.join("/"):S;if(!b)if(O)p.length<2&&(f.endsWith("/")?f=f.slice(0,-1):h=!0);else throw new Error(`Missing required param "${E}"`);f+=b}}return f||"/"}return{re:o,score:s,keys:r,parse:a,stringify:l}}function XS(t,e){let n=0;for(;n<t.length&&n<e.length;){const s=e[n]-t[n];if(s)return s;n++}return t.length<e.length?t.length===1&&t[0]===80?-1:1:t.length>e.length?e.length===1&&e[0]===80?1:-1:0}function G_(t,e){let n=0;const s=t.score,i=e.score;for(;n<s.length&&n<i.length;){const r=XS(s[n],i[n]);if(r)return r;n++}if(Math.abs(i.length-s.length)===1){if(Lh(s))return 1;if(Lh(i))return-1}return i.length-s.length}function Lh(t){const e=t[t.length-1];return t.length>0&&e[e.length-1]<0}const JS={type:0,value:""},ZS=/[a-zA-Z0-9_]/;function eI(t){if(!t)return[[]];if(t==="/")return[[JS]];if(!t.startsWith("/"))throw new Error(`Invalid path "${t}"`);function e(_){throw new Error(`ERR (${n})/"${u}": ${_}`)}let n=0,s=n;const i=[];let r;function o(){r&&i.push(r),r=[]}let a=0,l,u="",f="";function h(){u&&(n===0?r.push({type:0,value:u}):n===1||n===2||n===3?(r.length>1&&(l==="*"||l==="+")&&e(`A repeatable param (${u}) must be alone in its segment. eg: '/:ids+.`),r.push({type:1,value:u,regexp:f,repeatable:l==="*"||l==="+",optional:l==="*"||l==="?"})):e("Invalid state to consume buffer"),u="")}function p(){u+=l}for(;a<t.length;){if(l=t[a++],l==="\\"&&n!==2){s=n,n=4;continue}switch(n){case 0:l==="/"?(u&&h(),o()):l===":"?(h(),n=1):p();break;case 4:p(),n=s;break;case 1:l==="("?n=2:ZS.test(l)?p():(h(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&a--);break;case 2:l===")"?f[f.length-1]=="\\"?f=f.slice(0,-1)+l:n=3:f+=l;break;case 3:h(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&a--,f="";break;default:e("Unknown state");break}}return n===2&&e(`Unfinished custom RegExp for param "${u}"`),h(),o(),i}function tI(t,e,n){const s=QS(eI(t.path),n),i=we(s,{record:t,parent:e,children:[],alias:[]});return e&&!i.record.aliasOf==!e.record.aliasOf&&e.children.push(i),i}function nI(t,e){const n=[],s=new Map;e=$h({strict:!1,end:!0,sensitive:!1},e);function i(h){return s.get(h)}function r(h,p,_){const E=!_,T=sI(h);T.aliasOf=_&&_.record;const O=$h(e,h),S=[T];if("alias"in h){const N=typeof h.alias=="string"?[h.alias]:h.alias;for(const R of N)S.push(we({},T,{components:_?_.record.components:T.components,path:R,aliasOf:_?_.record:T}))}let b,C;for(const N of S){const{path:R}=N;if(p&&R[0]!=="/"){const D=p.record.path,K=D[D.length-1]==="/"?"":"/";N.path=p.record.path+(R&&K+R)}if(b=tI(N,p,O),_?_.alias.push(b):(C=C||b,C!==b&&C.alias.push(b),E&&h.name&&!Fh(b)&&o(h.name)),Y_(b)&&l(b),T.children){const D=T.children;for(let K=0;K<D.length;K++)r(D[K],b,_&&_.children[K])}_=_||b}return C?()=>{o(C)}:wr}function o(h){if(z_(h)){const p=s.get(h);p&&(s.delete(h),n.splice(n.indexOf(p),1),p.children.forEach(o),p.alias.forEach(o))}else{const p=n.indexOf(h);p>-1&&(n.splice(p,1),h.record.name&&s.delete(h.record.name),h.children.forEach(o),h.alias.forEach(o))}}function a(){return n}function l(h){const p=oI(h,n);n.splice(p,0,h),h.record.name&&!Fh(h)&&s.set(h.record.name,h)}function u(h,p){let _,E={},T,O;if("name"in h&&h.name){if(_=s.get(h.name),!_)throw xi(1,{location:h});O=_.record.name,E=we(Mh(p.params,_.keys.filter(C=>!C.optional).concat(_.parent?_.parent.keys.filter(C=>C.optional):[]).map(C=>C.name)),h.params&&Mh(h.params,_.keys.map(C=>C.name))),T=_.stringify(E)}else if(h.path!=null)T=h.path,_=n.find(C=>C.re.test(T)),_&&(E=_.parse(T),O=_.record.name);else{if(_=p.name?s.get(p.name):n.find(C=>C.re.test(p.path)),!_)throw xi(1,{location:h,currentLocation:p});O=_.record.name,E=we({},p.params,h.params),T=_.stringify(E)}const S=[];let b=_;for(;b;)S.unshift(b.record),b=b.parent;return{name:O,path:T,params:E,matched:S,meta:rI(S)}}t.forEach(h=>r(h));function f(){n.length=0,s.clear()}return{addRoute:r,resolve:u,removeRoute:o,clearRoutes:f,getRoutes:a,getRecordMatcher:i}}function Mh(t,e){const n={};for(const s of e)s in t&&(n[s]=t[s]);return n}function sI(t){return{path:t.path,redirect:t.redirect,name:t.name,meta:t.meta||{},aliasOf:void 0,beforeEnter:t.beforeEnter,props:iI(t),children:t.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in t?t.components||null:t.component&&{default:t.component}}}function iI(t){const e={},n=t.props||!1;if("component"in t)e.default=n;else for(const s in t.components)e[s]=typeof n=="object"?n[s]:n;return e}function Fh(t){for(;t;){if(t.record.aliasOf)return!0;t=t.parent}return!1}function rI(t){return t.reduce((e,n)=>we(e,n.meta),{})}function $h(t,e){const n={};for(const s in t)n[s]=s in e?e[s]:t[s];return n}function oI(t,e){let n=0,s=e.length;for(;n!==s;){const r=n+s>>1;G_(t,e[r])<0?s=r:n=r+1}const i=aI(t);return i&&(s=e.lastIndexOf(i,s-1)),s}function aI(t){let e=t;for(;e=e.parent;)if(Y_(e)&&G_(t,e)===0)return e}function Y_({record:t}){return!!(t.name||t.components&&Object.keys(t.components).length||t.redirect)}function lI(t){const e={};if(t===""||t==="?")return e;const s=(t[0]==="?"?t.slice(1):t).split("&");for(let i=0;i<s.length;++i){const r=s[i].replace(U_," "),o=r.indexOf("="),a=$r(o<0?r:r.slice(0,o)),l=o<0?null:$r(r.slice(o+1));if(a in e){let u=e[a];Gt(u)||(u=e[a]=[u]),u.push(l)}else e[a]=l}return e}function Uh(t){let e="";for(let n in t){const s=t[n];if(n=IS(n),s==null){s!==void 0&&(e+=(e.length?"&":"")+n);continue}(Gt(s)?s.map(r=>r&&Ic(r)):[s&&Ic(s)]).forEach(r=>{r!==void 0&&(e+=(e.length?"&":"")+n,r!=null&&(e+="="+r))})}return e}function cI(t){const e={};for(const n in t){const s=t[n];s!==void 0&&(e[n]=Gt(s)?s.map(i=>i==null?null:""+i):s==null?s:""+s)}return e}const uI=Symbol(""),Wh=Symbol(""),Fu=Symbol(""),q_=Symbol(""),Oc=Symbol("");function ur(){let t=[];function e(s){return t.push(s),()=>{const i=t.indexOf(s);i>-1&&t.splice(i,1)}}function n(){t=[]}return{add:e,list:()=>t.slice(),reset:n}}function jn(t,e,n,s,i,r=o=>o()){const o=s&&(s.enterCallbacks[i]=s.enterCallbacks[i]||[]);return()=>new Promise((a,l)=>{const u=p=>{p===!1?l(xi(4,{from:n,to:e})):p instanceof Error?l(p):GS(p)?l(xi(2,{from:e,to:p})):(o&&s.enterCallbacks[i]===o&&typeof p=="function"&&o.push(p),a())},f=r(()=>t.call(s&&s.instances[i],e,n,u));let h=Promise.resolve(f);t.length<3&&(h=h.then(u)),h.catch(p=>l(p))})}function Gl(t,e,n,s,i=r=>r()){const r=[];for(const o of t)for(const a in o.components){let l=o.components[a];if(!(e!=="beforeRouteEnter"&&!o.instances[a]))if(fI(l)){const f=(l.__vccOpts||l)[e];f&&r.push(jn(f,n,s,o,a,i))}else{let u=l();r.push(()=>u.then(f=>{if(!f)return Promise.reject(new Error(`Couldn't resolve component "${a}" at "${o.path}"`));const h=mS(f)?f.default:f;o.components[a]=h;const _=(h.__vccOpts||h)[e];return _&&jn(_,n,s,o,a,i)()}))}}return r}function fI(t){return typeof t=="object"||"displayName"in t||"props"in t||"__vccOpts"in t}function Vh(t){const e=En(Fu),n=En(q_),s=Ve(()=>{const l=jt(t.to);return e.resolve(l)}),i=Ve(()=>{const{matched:l}=s.value,{length:u}=l,f=l[u-1],h=n.matched;if(!f||!h.length)return-1;const p=h.findIndex(Pi.bind(null,f));if(p>-1)return p;const _=Hh(l[u-2]);return u>1&&Hh(f)===_&&h[h.length-1].path!==_?h.findIndex(Pi.bind(null,l[u-2])):p}),r=Ve(()=>i.value>-1&&pI(n.params,s.value.params)),o=Ve(()=>i.value>-1&&i.value===n.matched.length-1&&j_(n.params,s.value.params));function a(l={}){return hI(l)?e[jt(t.replace)?"replace":"push"](jt(t.to)).catch(wr):Promise.resolve()}return{route:s,href:Ve(()=>s.value.href),isActive:r,isExactActive:o,navigate:a}}const dI=Ru({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:Vh,setup(t,{slots:e}){const n=Ka(Vh(t)),{options:s}=En(Fu),i=Ve(()=>({[jh(t.activeClass,s.linkActiveClass,"router-link-active")]:n.isActive,[jh(t.exactActiveClass,s.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const r=e.default&&e.default(n);return t.custom?r:Lu("a",{"aria-current":n.isExactActive?t.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:i.value},r)}}}),fa=dI;function hI(t){if(!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)&&!t.defaultPrevented&&!(t.button!==void 0&&t.button!==0)){if(t.currentTarget&&t.currentTarget.getAttribute){const e=t.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return t.preventDefault&&t.preventDefault(),!0}}function pI(t,e){for(const n in e){const s=e[n],i=t[n];if(typeof s=="string"){if(s!==i)return!1}else if(!Gt(i)||i.length!==s.length||s.some((r,o)=>r!==i[o]))return!1}return!0}function Hh(t){return t?t.aliasOf?t.aliasOf.path:t.path:""}const jh=(t,e,n)=>t??e??n,mI=Ru({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(t,{attrs:e,slots:n}){const s=En(Oc),i=Ve(()=>t.route||s.value),r=En(Wh,0),o=Ve(()=>{let u=jt(r);const{matched:f}=i.value;let h;for(;(h=f[u])&&!h.components;)u++;return u}),a=Ve(()=>i.value.matched[o.value]);Ko(Wh,Ve(()=>o.value+1)),Ko(uI,a),Ko(Oc,i);const l=De();return Ei(()=>[l.value,a.value,t.name],([u,f,h],[p,_,E])=>{f&&(f.instances[h]=u,_&&_!==f&&u&&u===p&&(f.leaveGuards.size||(f.leaveGuards=_.leaveGuards),f.updateGuards.size||(f.updateGuards=_.updateGuards))),u&&f&&(!_||!Pi(f,_)||!p)&&(f.enterCallbacks[h]||[]).forEach(T=>T(u))},{flush:"post"}),()=>{const u=i.value,f=t.name,h=a.value,p=h&&h.components[f];if(!p)return Bh(n.default,{Component:p,route:u});const _=h.props[f],E=_?_===!0?u.params:typeof _=="function"?_(u):_:null,O=Lu(p,we({},E,e,{onVnodeUnmounted:S=>{S.component.isUnmounted&&(h.instances[f]=null)},ref:l}));return Bh(n.default,{Component:O,route:u})||O}}});function Bh(t,e){if(!t)return null;const n=t(e);return n.length===1?n[0]:n}const Q_=mI;function _I(t){const e=nI(t.routes,t),n=t.parseQuery||lI,s=t.stringifyQuery||Uh,i=t.history,r=ur(),o=ur(),a=ur(),l=T0(Fn);let u=Fn;fi&&t.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const f=zl.bind(null,x=>""+x),h=zl.bind(null,OS),p=zl.bind(null,$r);function _(x,B){let z,Y;return z_(x)?(z=e.getRecordMatcher(x),Y=B):Y=x,e.addRoute(Y,z)}function E(x){const B=e.getRecordMatcher(x);B&&e.removeRoute(B)}function T(){return e.getRoutes().map(x=>x.record)}function O(x){return!!e.getRecordMatcher(x)}function S(x,B){if(B=we({},B||l.value),typeof x=="string"){const v=Kl(n,x,B.path),w=e.resolve({path:v.path},B),L=i.createHref(v.fullPath);return we(v,w,{params:p(w.params),hash:$r(v.hash),redirectedFrom:void 0,href:L})}let z;if(x.path!=null)z=we({},x,{path:Kl(n,x.path,B.path).path});else{const v=we({},x.params);for(const w in v)v[w]==null&&delete v[w];z=we({},x,{params:h(v)}),B.params=h(B.params)}const Y=e.resolve(z,B),A=x.hash||"";Y.params=f(p(Y.params));const Ee=PS(s,we({},x,{hash:SS(A),path:Y.path})),m=i.createHref(Ee);return we({fullPath:Ee,hash:A,query:s===Uh?cI(x.query):x.query||{}},Y,{redirectedFrom:void 0,href:m})}function b(x){return typeof x=="string"?Kl(n,x,l.value.path):we({},x)}function C(x,B){if(u!==x)return xi(8,{from:B,to:x})}function N(x){return K(x)}function R(x){return N(we(b(x),{replace:!0}))}function D(x){const B=x.matched[x.matched.length-1];if(B&&B.redirect){const{redirect:z}=B;let Y=typeof z=="function"?z(x):z;return typeof Y=="string"&&(Y=Y.includes("?")||Y.includes("#")?Y=b(Y):{path:Y},Y.params={}),we({query:x.query,hash:x.hash,params:Y.path!=null?{}:x.params},Y)}}function K(x,B){const z=u=S(x),Y=l.value,A=x.state,Ee=x.force,m=x.replace===!0,v=D(z);if(v)return K(we(b(v),{state:typeof v=="object"?we({},A,v.state):A,force:Ee,replace:m}),B||z);const w=z;w.redirectedFrom=B;let L;return!Ee&&xS(s,Y,z)&&(L=xi(16,{to:w,from:Y}),qe(Y,Y,!0,!1)),(L?Promise.resolve(L):se(w,Y)).catch(P=>dn(P)?dn(P,2)?P:rt(P):ue(P,w,Y)).then(P=>{if(P){if(dn(P,2))return K(we({replace:m},b(P.to),{state:typeof P.to=="object"?we({},A,P.to.state):A,force:Ee}),B||w)}else P=Le(w,Y,!0,m,A);return le(w,Y,P),P})}function ae(x,B){const z=C(x,B);return z?Promise.reject(z):Promise.resolve()}function te(x){const B=ot.values().next().value;return B&&typeof B.runWithContext=="function"?B.runWithContext(x):x()}function se(x,B){let z;const[Y,A,Ee]=gI(x,B);z=Gl(Y.reverse(),"beforeRouteLeave",x,B);for(const v of Y)v.leaveGuards.forEach(w=>{z.push(jn(w,x,B))});const m=ae.bind(null,x,B);return z.push(m),$e(z).then(()=>{z=[];for(const v of r.list())z.push(jn(v,x,B));return z.push(m),$e(z)}).then(()=>{z=Gl(A,"beforeRouteUpdate",x,B);for(const v of A)v.updateGuards.forEach(w=>{z.push(jn(w,x,B))});return z.push(m),$e(z)}).then(()=>{z=[];for(const v of Ee)if(v.beforeEnter)if(Gt(v.beforeEnter))for(const w of v.beforeEnter)z.push(jn(w,x,B));else z.push(jn(v.beforeEnter,x,B));return z.push(m),$e(z)}).then(()=>(x.matched.forEach(v=>v.enterCallbacks={}),z=Gl(Ee,"beforeRouteEnter",x,B,te),z.push(m),$e(z))).then(()=>{z=[];for(const v of o.list())z.push(jn(v,x,B));return z.push(m),$e(z)}).catch(v=>dn(v,8)?v:Promise.reject(v))}function le(x,B,z){a.list().forEach(Y=>te(()=>Y(x,B,z)))}function Le(x,B,z,Y,A){const Ee=C(x,B);if(Ee)return Ee;const m=B===Fn,v=fi?history.state:{};z&&(Y||m?i.replace(x.fullPath,we({scroll:m&&v&&v.scroll},A)):i.push(x.fullPath,A)),l.value=x,qe(x,B,z,m),rt()}let ve;function it(){ve||(ve=i.listen((x,B,z)=>{if(!Ze.listening)return;const Y=S(x),A=D(Y);if(A){K(we(A,{replace:!0}),Y).catch(wr);return}u=Y;const Ee=l.value;fi&&WS(Ph(Ee.fullPath,z.delta),el()),se(Y,Ee).catch(m=>dn(m,12)?m:dn(m,2)?(K(m.to,Y).then(v=>{dn(v,20)&&!z.delta&&z.type===Ur.pop&&i.go(-1,!1)}).catch(wr),Promise.reject()):(z.delta&&i.go(-z.delta,!1),ue(m,Y,Ee))).then(m=>{m=m||Le(Y,Ee,!1),m&&(z.delta&&!dn(m,8)?i.go(-z.delta,!1):z.type===Ur.pop&&dn(m,20)&&i.go(-1,!1)),le(Y,Ee,m)}).catch(wr)}))}let Je=ur(),me=ur(),ie;function ue(x,B,z){rt(x);const Y=me.list();return Y.length?Y.forEach(A=>A(x,B,z)):console.error(x),Promise.reject(x)}function Ue(){return ie&&l.value!==Fn?Promise.resolve():new Promise((x,B)=>{Je.add([x,B])})}function rt(x){return ie||(ie=!x,it(),Je.list().forEach(([B,z])=>x?z(x):B()),Je.reset()),x}function qe(x,B,z,Y){const{scrollBehavior:A}=t;if(!fi||!A)return Promise.resolve();const Ee=!z&&VS(Ph(x.fullPath,0))||(Y||!z)&&history.state&&history.state.scroll||null;return Ou().then(()=>A(x,B,Ee)).then(m=>m&&US(m)).catch(m=>ue(m,x,B))}const ke=x=>i.go(x);let bt;const ot=new Set,Ze={currentRoute:l,listening:!0,addRoute:_,removeRoute:E,clearRoutes:e.clearRoutes,hasRoute:O,getRoutes:T,resolve:S,options:t,push:N,replace:R,go:ke,back:()=>ke(-1),forward:()=>ke(1),beforeEach:r.add,beforeResolve:o.add,afterEach:a.add,onError:me.add,isReady:Ue,install(x){const B=this;x.component("RouterLink",fa),x.component("RouterView",Q_),x.config.globalProperties.$router=B,Object.defineProperty(x.config.globalProperties,"$route",{enumerable:!0,get:()=>jt(l)}),fi&&!bt&&l.value===Fn&&(bt=!0,N(i.location).catch(A=>{}));const z={};for(const A in Fn)Object.defineProperty(z,A,{get:()=>l.value[A],enumerable:!0});x.provide(Fu,B),x.provide(q_,Jm(z)),x.provide(Oc,l);const Y=x.unmount;ot.add(x),x.unmount=function(){ot.delete(x),ot.size<1&&(u=Fn,ve&&ve(),ve=null,l.value=Fn,bt=!1,ie=!1),Y()}}};function $e(x){return x.reduce((B,z)=>B.then(()=>te(z)),Promise.resolve())}return Ze}function gI(t,e){const n=[],s=[],i=[],r=Math.max(e.matched.length,t.matched.length);for(let o=0;o<r;o++){const a=e.matched[o];a&&(t.matched.find(u=>Pi(u,a))?s.push(a):n.push(a));const l=t.matched[o];l&&(e.matched.find(u=>Pi(u,l))||i.push(l))}return[n,s,i]}const vI={__name:"App",setup(t){return(e,n)=>(Re(),hi(jt(Q_)))}},yI="/assets/logo-woT2z67z.png",bI={class:"bg-warning vh-100 d-flex justify-content-center align-items-center",style:{overflow:"auto"}},EI={class:"container w-50"},wI={class:"bg-white rounded-circle mx-auto p-3 mb-3",style:{"box-shadow":"4px 4px 16px rgba(0, 0, 0, 0.5)","max-width":"150px"}},CI=["src"],TI=$("h1",{class:"text-center mb-3"},"WordMate",-1),SI=$("hr",{class:"mb-3",style:{width:"80%",margin:"auto"}},null,-1),II=$("label",null,"請輸入暱稱",-1),AI=$("label",{class:"mt-3"},"請輸入密碼",-1),OI={key:0,class:"text-danger mt-1 text-end"},NI={__name:"LoginView",setup(t){const e=De({name:"",pw:""}),n=De(!1),s=()=>{const i=e.value.name.toLowerCase(),r=e.value.pw.toLowerCase();(i==="alex"||i==="yiyu")&&r==="520520"?(localStorage.setItem("memorize_name",e.value.name),localStorage.setItem("memorize_pw",e.value.pw),Jr.push("/")):n.value=!0};return(i,r)=>(Re(),Ke("div",bI,[$("div",EI,[$("div",null,[$("div",wI,[$("img",{src:jt(yI),alt:"WordMate",class:"w-100"},null,8,CI)])]),TI,SI,II,pn($("input",{type:"text",class:"form-control","onUpdate:modelValue":r[0]||(r[0]=o=>e.value.name=o),onKeyup:Ih(s,["enter"])},null,544),[[Ds,e.value.name]]),AI,pn($("input",{type:"password",class:"form-control","onUpdate:modelValue":r[1]||(r[1]=o=>e.value.pw=o),onKeyup:Ih(s,["enter"])},null,544),[[Ds,e.value.pw]]),n.value?(Re(),Ke("div",OI,"暱稱或密碼錯誤，請詢問管理員")):Vn("",!0),$("button",{type:"button",class:"btn btn-primary mt-3 w-100",onClick:s},"登入")])]))}};var zh={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yA{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(bA(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function bA(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const xc="@firebase/app",Qh="0.10.10";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cn=new Vu("@firebase/app"),EA="@firebase/app-compat",wA="@firebase/analytics-compat",CA="@firebase/analytics",TA="@firebase/app-check-compat",SA="@firebase/app-check",IA="@firebase/auth",AA="@firebase/auth-compat",OA="@firebase/database",NA="@firebase/database-compat",RA="@firebase/functions",PA="@firebase/functions-compat",xA="@firebase/installations",kA="@firebase/installations-compat",DA="@firebase/messaging",LA="@firebase/messaging-compat",MA="@firebase/performance",FA="@firebase/performance-compat",$A="@firebase/remote-config",UA="@firebase/remote-config-compat",WA="@firebase/storage",VA="@firebase/storage-compat",HA="@firebase/firestore",jA="@firebase/vertexai-preview",BA="@firebase/firestore-compat",zA="firebase",KA="10.13.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kc="[DEFAULT]",GA={[xc]:"fire-core",[EA]:"fire-core-compat",[CA]:"fire-analytics",[wA]:"fire-analytics-compat",[SA]:"fire-app-check",[TA]:"fire-app-check-compat",[IA]:"fire-auth",[AA]:"fire-auth-compat",[OA]:"fire-rtdb",[NA]:"fire-rtdb-compat",[RA]:"fire-fn",[PA]:"fire-fn-compat",[xA]:"fire-iid",[kA]:"fire-iid-compat",[DA]:"fire-fcm",[LA]:"fire-fcm-compat",[MA]:"fire-perf",[FA]:"fire-perf-compat",[$A]:"fire-rc",[UA]:"fire-rc-compat",[WA]:"fire-gcs",[VA]:"fire-gcs-compat",[HA]:"fire-fst",[BA]:"fire-fst-compat",[jA]:"fire-vertex","fire-js":"fire-js",[zA]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ku="5",vg="v",yg="s",bg="r",Eg="f",wg=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Cg="ls",Tg="p",Mc="ac",Sg="websocket",Ig="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uO=Math.log(2);class fO{constructor(e){const n=r=>parseInt(Math.log(r)/uO,10),s=r=>parseInt(Array(r+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const i=s(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const ya=function(t,e,n,s){t.sort(e);const i=function(l,u){const f=u-l;let h,p;if(f===0)return null;if(f===1)return h=t[l],p=n?n(h):h,new Ye(p,h.node,Ye.BLACK,null,null);{const _=parseInt(f/2,10)+l,E=i(l,_),T=i(_+1,u);return h=t[_],p=n?n(h):h,new Ye(p,h.node,Ye.BLACK,E,T)}},r=function(l){let u=null,f=null,h=t.length;const p=function(E,T){const O=h-E,S=h;h-=E;const b=i(O+1,S),C=t[O],N=n?n(C):C;_(new Ye(N,C.node,T,null,b))},_=function(E){u?(u.left=E,u=E):(f=E,u=E)};for(let E=0;E<l.count;++E){const T=l.nextBitIsOne(),O=Math.pow(2,l.count-(E+1));T?p(O,Ye.BLACK):(p(O,Ye.BLACK),p(O,Ye.RED))}return f},o=new fO(t.length),a=r(o);return new gt(s||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ba extends Dg{constructor(e,n,s,i){super(),this.repoInfo_=e,this.onDataUpdate_=n,this.authTokenProvider_=s,this.appCheckTokenProvider_=i,this.log_=oo("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,n){return n!==void 0?"tag$"+n:(W(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,n,s,i){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const o=ba.getListenId_(e,s),a={};this.listens_[o]=a;const l=vp(e._queryParams);this.restRequest_(r+".json",l,(u,f)=>{let h=f;if(u===404&&(h=null,u=null),u===null&&this.onDataUpdate_(r,h,!1,s),ki(this.listens_,o)===a){let p;u?u===401?p="permission_denied":p="rest_error:"+u:p="ok",i(p,null)}})}unlisten(e,n){const s=ba.getListenId_(e,n);delete this.listens_[s]}get(e){const n=vp(e._queryParams),s=e._path.toString(),i=new so;return this.restRequest_(s+".json",n,(r,o)=>{let a=o;r===404&&(a=null,r=null),r===null?(this.onDataUpdate_(s,a,!1,null),i.resolve(a)):i.reject(new Error(a))}),i.promise}refreshAuthToken(e){}restRequest_(e,n={},s){return n.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([i,r])=>{i&&i.accessToken&&(n.auth=i.accessToken),r&&r.token&&(n.ac=r.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+qi(n);this.log_("Sending REST request for "+o);const a=new XMLHttpRequest;a.onreadystatechange=()=>{if(s&&a.readyState===4){this.log_("REST Response for "+o+" received. status:",a.status,"response:",a.responseText);let l=null;if(a.status>=200&&a.status<300){try{l=Wr(a.responseText)}catch{ut("Failed to parse JSON response for "+o+": "+a.responseText)}s(null,l)}else a.status!==401&&a.status!==404&&ut("Got unsuccessful REST response for "+o+" Status: "+a.status),s(a.status);s=null}},a.open("GET",o,!0),a.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bO{constructor(){this.rootNode_=J.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,n){this.rootNode_=this.rootNode_.updateChild(e,n)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ea(){return{value:null,children:new Map}}function Bg(t,e,n){if(he(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const s=fe(e);t.children.has(s)||t.children.set(s,Ea());const i=t.children.get(s);e=Ae(e),Bg(i,e,n)}}function $c(t,e,n){t.value!==null?n(e,t.value):EO(t,(s,i)=>{const r=new Te(e.toString()+"/"+s);$c(i,r,n)})}function EO(t,e){t.children.forEach((n,s)=>{e(s,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bp=10*1e3,CO=30*1e3,TO=5*60*1e3;class SO{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new wO(e);const s=bp+(CO-bp)*Math.random();Sr(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),n={};let s=!1;Xe(e,(i,r)=>{r>0&&ln(this.statsToReport_,i)&&(n[i]=r,s=!0)}),s&&this.server_.reportStats(n),Sr(this.reportStats_.bind(this),Math.floor(Math.random()*2*TO))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const VN="repo_interrupt",HN=25;class jN{constructor(e,n,s,i){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=s,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new UN,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Ea(),this.transactionQueueTree_=new _f,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function BN(t,e,n){if(t.stats_=Gu(t.repoInfo_),t.forceRestClient_||E1())t.server_=new ba(t.repoInfo_,(s,i,r,o)=>{Pp(t,s,i,r,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>xp(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{je(n)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}t.persistentConnection_=new wn(t.repoInfo_,e,(s,i,r,o)=>{Pp(t,s,i,r,o)},s=>{xp(t,s)},s=>{zN(t,s)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(s=>{t.server_.refreshAuthToken(s)}),t.appCheckProvider_.addTokenChangeListener(s=>{t.server_.refreshAppCheckToken(s.token)}),t.statsReporter_=I1(t.repoInfo_,()=>new SO(t.stats_,t.server_)),t.infoData_=new bO,t.infoSyncTree_=new Np({startListening:(s,i,r,o)=>{let a=[];const l=t.infoData_.getNode(s._path);return l.isEmpty()||(a=lo(t.infoSyncTree_,s._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),bf(t,"connected",!1),t.serverSyncTree_=new Np({startListening:(s,i,r,o)=>(t.server_.listen(s,r,i,(a,l)=>{const u=o(a,l);Ft(t.eventQueue_,s._path,u)}),[]),stopListening:(s,i)=>{t.server_.unlisten(s,i)}})}function bv(t){const n=t.infoData_.getNode(new Te(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function fl(t){return SN({timestamp:bv(t)})}function Pp(t,e,n,s,i){t.dataUpdateCount++;const r=new Te(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(i)if(s){const l=pa(n,u=>He(u));o=yN(t.serverSyncTree_,r,l,i)}else{const l=He(n);o=ov(t.serverSyncTree_,r,l,i)}else if(s){const l=pa(n,u=>He(u));o=_N(t.serverSyncTree_,r,l)}else{const l=He(n);o=lo(t.serverSyncTree_,r,l)}let a=r;o.length>0&&(a=Ui(t,r)),Ft(t.eventQueue_,a,o)}function xp(t,e){bf(t,"connected",e),e===!1&&qN(t)}function zN(t,e){Xe(e,(n,s)=>{bf(t,n,s)})}function bf(t,e,n){const s=new Te("/.info/"+e),i=He(n);t.infoData_.updateSnapshot(s,i);const r=lo(t.infoSyncTree_,s,i);Ft(t.eventQueue_,s,r)}function Ef(t){return t.nextWriteId_++}function KN(t,e,n){const s=bN(t.serverSyncTree_,e);return s!=null?Promise.resolve(s):t.server_.get(e).then(i=>{const r=He(i).withIndex(e._queryParams.getIndex());Bc(t.serverSyncTree_,e,n,!0);let o;if(e._queryParams.loadsAllData())o=lo(t.serverSyncTree_,e._path,r);else{const a=Yr(t.serverSyncTree_,e);o=ov(t.serverSyncTree_,e._path,r,a)}return Ft(t.eventQueue_,e._path,o),Na(t.serverSyncTree_,e,n,null,!0),r},i=>(uo(t,"get for query "+je(e)+" failed: "+i),Promise.reject(new Error(i))))}function GN(t,e,n,s,i){uo(t,"set",{path:e.toString(),value:n,priority:s});const r=fl(t),o=He(n,s),a=cf(t.serverSyncTree_,e),l=fv(o,a,r),u=Ef(t),f=rv(t.serverSyncTree_,e,l,u,!0);ul(t.eventQueue_,f),t.server_.put(e.toString(),o.val(!0),(p,_)=>{const E=p==="ok";E||ut("set at "+e+" failed: "+p);const T=Qn(t.serverSyncTree_,u,!E);Ft(t.eventQueue_,e,T),Kc(t,i,p,_)});const h=Cf(t,e);Ui(t,h),Ft(t.eventQueue_,h,[])}function YN(t,e,n,s){uo(t,"update",{path:e.toString(),value:n});let i=!0;const r=fl(t),o={};if(Xe(n,(a,l)=>{i=!1,o[a]=uv(Me(e,a),He(l),t.serverSyncTree_,r)}),i)Qe("update() called with empty data.  Don't do anything."),Kc(t,s,"ok",void 0);else{const a=Ef(t),l=mN(t.serverSyncTree_,e,o,a);ul(t.eventQueue_,l),t.server_.merge(e.toString(),n,(u,f)=>{const h=u==="ok";h||ut("update at "+e+" failed: "+u);const p=Qn(t.serverSyncTree_,a,!h),_=p.length>0?Ui(t,e):e;Ft(t.eventQueue_,_,p),Kc(t,s,u,f)}),Xe(n,u=>{const f=Cf(t,Me(e,u));Ui(t,f)}),Ft(t.eventQueue_,e,[])}}function qN(t){uo(t,"onDisconnectEvents");const e=fl(t),n=Ea();$c(t.onDisconnect_,ge(),(i,r)=>{const o=uv(i,r,t.serverSyncTree_,e);Bg(n,i,o)});let s=[];$c(n,ge(),(i,r)=>{s=s.concat(lo(t.serverSyncTree_,i,r));const o=Cf(t,i);Ui(t,o)}),t.onDisconnect_=Ea(),Ft(t.eventQueue_,ge(),s)}function QN(t,e,n){let s;fe(e._path)===".info"?s=Bc(t.infoSyncTree_,e,n):s=Bc(t.serverSyncTree_,e,n),vv(t.eventQueue_,e._path,s)}function XN(t,e,n){let s;fe(e._path)===".info"?s=Na(t.infoSyncTree_,e,n):s=Na(t.serverSyncTree_,e,n),vv(t.eventQueue_,e._path,s)}function JN(t){t.persistentConnection_&&t.persistentConnection_.interrupt(VN)}function uo(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),Qe(n,...e)}function Kc(t,e,n,s){e&&Xi(()=>{if(n==="ok")e(null);else{const i=(n||"error").toUpperCase();let r=i;s&&(r+=": "+s);const o=new Error(r);o.code=i,e(o)}})}function Ev(t,e,n){return cf(t.serverSyncTree_,e,n)||J.EMPTY_NODE}function wf(t,e=t.transactionQueueTree_){if(e||dl(t,e),Zi(e)){const n=Cv(t,e);W(n.length>0,"Sending zero length transaction queue"),n.every(i=>i.status===0)&&ZN(t,co(e),n)}else hv(e)&&ll(e,n=>{wf(t,n)})}function ZN(t,e,n){const s=n.map(u=>u.currentWriteId),i=Ev(t,e,s);let r=i;const o=i.hash();for(let u=0;u<n.length;u++){const f=n[u];W(f.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),f.status=1,f.retryCount++;const h=ct(e,f.path);r=r.updateChild(h,f.currentOutputSnapshotRaw)}const a=r.val(!0),l=e;t.server_.put(l.toString(),a,u=>{uo(t,"transaction put response",{path:l.toString(),status:u});let f=[];if(u==="ok"){const h=[];for(let p=0;p<n.length;p++)n[p].status=2,f=f.concat(Qn(t.serverSyncTree_,n[p].currentWriteId)),n[p].onComplete&&h.push(()=>n[p].onComplete(null,!0,n[p].currentOutputSnapshotResolved)),n[p].unwatcher();dl(t,gf(t.transactionQueueTree_,e)),wf(t,t.transactionQueueTree_),Ft(t.eventQueue_,e,f);for(let p=0;p<h.length;p++)Xi(h[p])}else{if(u==="datastale")for(let h=0;h<n.length;h++)n[h].status===3?n[h].status=4:n[h].status=0;else{ut("transaction at "+l.toString()+" failed: "+u);for(let h=0;h<n.length;h++)n[h].status=4,n[h].abortReason=u}Ui(t,e)}},o)}function Ui(t,e){const n=wv(t,e),s=co(n),i=Cv(t,n);return eR(t,i,s),s}function eR(t,e,n){if(e.length===0)return;const s=[];let i=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],u=ct(n,l.path);let f=!1,h;if(W(u!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)f=!0,h=l.abortReason,i=i.concat(Qn(t.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=HN)f=!0,h="maxretry",i=i.concat(Qn(t.serverSyncTree_,l.currentWriteId,!0));else{const p=Ev(t,l.path,o);l.currentInputSnapshot=p;const _=e[a].update(p.val());if(_!==void 0){cl("transaction failed: Data returned ",_,l.path);let E=He(_);typeof _=="object"&&_!=null&&ln(_,".priority")||(E=E.updatePriority(p.getPriority()));const O=l.currentWriteId,S=fl(t),b=fv(E,p,S);l.currentOutputSnapshotRaw=E,l.currentOutputSnapshotResolved=b,l.currentWriteId=Ef(t),o.splice(o.indexOf(O),1),i=i.concat(rv(t.serverSyncTree_,l.path,b,l.currentWriteId,l.applyLocally)),i=i.concat(Qn(t.serverSyncTree_,O,!0))}else f=!0,h="nodata",i=i.concat(Qn(t.serverSyncTree_,l.currentWriteId,!0))}Ft(t.eventQueue_,n,i),i=[],f&&(e[a].status=2,function(p){setTimeout(p,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(h==="nodata"?s.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):s.push(()=>e[a].onComplete(new Error(h),!1,null))))}dl(t,t.transactionQueueTree_);for(let a=0;a<s.length;a++)Xi(s[a]);wf(t,t.transactionQueueTree_)}function wv(t,e){let n,s=t.transactionQueueTree_;for(n=fe(e);n!==null&&Zi(s)===void 0;)s=gf(s,n),e=Ae(e),n=fe(e);return s}function Cv(t,e){const n=[];return Tv(t,e,n),n.sort((s,i)=>s.order-i.order),n}function Tv(t,e,n){const s=Zi(e);if(s)for(let i=0;i<s.length;i++)n.push(s[i]);ll(e,i=>{Tv(t,i,n)})}function dl(t,e){const n=Zi(e);if(n){let s=0;for(let i=0;i<n.length;i++)n[i].status!==2&&(n[s]=n[i],s++);n.length=s,dv(e,n.length>0?n:void 0)}ll(e,s=>{dl(t,s)})}function Cf(t,e){const n=co(wv(t,e)),s=gf(t.transactionQueueTree_,e);return NN(s,i=>{rc(t,i)}),rc(t,s),pv(s,i=>{rc(t,i)}),n}function rc(t,e){const n=Zi(e);if(n){const s=[];let i=[],r=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(W(r===o-1,"All SENT items should be at beginning of queue."),r=o,n[o].status=3,n[o].abortReason="set"):(W(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),i=i.concat(Qn(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&s.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?dv(e,void 0):n.length=r+1,Ft(t.eventQueue_,co(e),i);for(let o=0;o<s.length;o++)Xi(s[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ER(t){o1(Qi),Di(new Bs("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return mR(s,i,r,n)},"PUBLIC").setMultipleInstances(!0)),ns(np,sp,t),ns(np,sp,"esm2017")}wn.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};wn.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};ER();var wR="firebase",CR="10.13.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
